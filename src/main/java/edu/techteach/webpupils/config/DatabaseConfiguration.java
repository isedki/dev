package edu.techteach.webpupils.config;

import edu.techteach.webpupils.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("edu.techteach.webpupils.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("edu.techteach.webpupils.repository.search")
